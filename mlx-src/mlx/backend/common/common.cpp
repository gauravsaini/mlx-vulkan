...
template <typename T>
void write_scalar(array& out, T value) {
  allocator::copy_from_host(out.buffer(), &value, sizeof(T), out.offset());
}
...
void NumberOfElements::eval(const std::vector<array>& inputs, array& out) {
  ...
  switch (out.dtype()) {
    case bool_:
      write_scalar(out, static_cast<bool>(numel));
      break;
    case uint8:
      write_scalar(out, static_cast<uint8_t>(numel));
      break;
    case uint16:
      write_scalar(out, static_cast<uint16_t>(numel));
      break;
    case uint32:
      write_scalar(out, static_cast<uint32_t>(numel));
      break;
    case uint64:
      write_scalar(out, static_cast<uint64_t>(numel));
      break;
    case int8:
      write_scalar(out, static_cast<int8_t>(numel));
      break;
    case int16:
      write_scalar(out, static_cast<int16_t>(numel));
      break;
    case int32:
      write_scalar(out, static_cast<int32_t>(numel));
      break;
    case int64:
      write_scalar(out, static_cast<int64_t>(numel));
      break;
    case float16:
      write_scalar(out, static_cast<float16_t>(numel));
      break;
    case float32:
      write_scalar(out, static_cast<float>(numel));
      break;
    case bfloat16:
      write_scalar(out, static_cast<bfloat16_t>(numel));
      break;
    case float64:
      write_scalar(out, static_cast<double>(numel));
      break;
    case complex64:
      write_scalar(out, static_cast<complex64_t>(numel));
      break;
  }
}
